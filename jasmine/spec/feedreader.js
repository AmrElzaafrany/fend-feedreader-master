...
$(function() {
    ...
    describe('RSS Feeds', function() {
         ...
         */
        it('all feeds has url is defined', function() {
         ...
         */
        it('all feeds has name is defined', function() {
    ...
    describe('The menu', function() {
         ...
         */
        it('menu is show or hidden when click', function() {
    ...
    describe('New Feed Selection', function() {
         ...
         */
        let
            defaultContent, updateContent;
        beforeEach(function(done) {
            loadFeed(0, function() {
                defaultContent = $('.feed').text();
                loadFeed(1, function() {
                    updateContent = $('.feed').text();
                    done();
                });
            });
        });
